...
# Prepare a mesh
N = 20
mesh = RectangleMesh(-100., -100.0, 100.0, 100.0, N,N)
...
# Analytical solution
u_D = Expression(".1*cos(pi*x[0]/50)+cos(pi*x[1]/50)+exp(.88*t)+2",t=t)
u_E = interpolate(u_E,V)
Lu = Expression(".088*exp(.88*t)+.1*pow(pi/50,2)*(cos(pi*x[0]/50)+cos(pi*x[1]/50))",t=t)
